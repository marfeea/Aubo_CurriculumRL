...
from .curriculumrl_marl_env_cfg import CurriculumrlMarlEnvCfg


class CurriculumrlMarlEnv(DirectMARLEnv):
    cfg: CurriculumrlMarlEnvCfg

    def __init__(self, cfg: CurriculumrlMarlEnvCfg, render_mode: str | None = None, **kwargs):
